...
//import com.example.band_search2.domain.request.CommunityMemberReqeust;
...
//    public void listen(Community community) {
//        System.out.println("consumer : " + community);
//
//        CommunityRequest communityRequest = CommunityRequest.builder()
//                .ownerId(community.getOwnerId())
//                .name(community.getName())
//                .location(community.getLocation())
//                .category(community.getCategory())
//                .interest(community.getInterest())
//                .description(community.getDescription())
//                .profileImage(community.getProfileImage())
//                .build();
//
////        communityService.communitySave(communityRequest.toEntity());
//    }
//
